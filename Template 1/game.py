...
def print_menu_line(direction, leads_to):
    ...
    """
    line1 = leads_to
    line2 = direction.upper()
    print("Go", line2, "to", line1 + ".")
...
def menu(exits):
    ...
    while True:
        ...
        is_valid_exit(exits, Normalised_input)
